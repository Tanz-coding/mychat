      ...
      <div class="chat-bubble-content">
        <div slot="content">
          ...
          <div v-if="message.type==='file'" class="file-message">
            <div class="file-icon">
              <img :src="getFileIcon(message.content)" alt="file icon">
            </div>
            <div class="file-info">
              <a :href="message.content" target="_blank" :download="getFileName(message.content)">{{getFileName(message.content)}}</a>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getFileSize() {
        // This is a placeholder. In a real application, you would fetch the file size from the server.
        // For now, let's return a dummy size.
        return '862.6K';
      },
      getFileIcon(filePath) {
        ...
        if (fileExtension === 'pdf') {
          ...
          return require('../assets/images/txt.svg');
        }
        return require('../assets/file.png'); // Default icon
      }
    }
  }
</script>
