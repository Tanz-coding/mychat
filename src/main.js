...
Vue.directive('drag', {
  bind(el) {
    ...
    const originTransform = baseTransform && baseTransform !== 'none' ? baseTransform : '';
    function applyTransform() {
      const dragTransform = `translate(${setPos.x}px,${setPos.y}px)`;
      el.style.transform = originTransform ? `${originTransform} ${dragTransform}` : dragTransform;
    }
